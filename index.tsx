...
import {
    ...
    Platform, ScrollView, StyleProp, StyleSheet,
    Text, TextStyle, TouchableOpacity, TouchableWithoutFeedback, View,
    ViewStyle
} from 'react-native';
...
interface CarouselProps {
    ...
    pageInfoTextStyle?: StyleProp<TextStyle>;
    pageInfoBottomContainerStyle?: StyleProp<ViewStyle>;
    pageInfoTextSeparator?: string;
    bullets?: boolean;
    bulletsContainerStyle?: StyleProp<TextStyle>;
    bulletStyle?: StyleProp<TextStyle>;
    arrows?: boolean;
    arrowsContainerStyle?: StyleProp<TextStyle>;
    arrowStyle?: StyleProp<TextStyle>;
    leftArrowStyle?: StyleProp<TextStyle>;
    rightArrowStyle?: StyleProp<TextStyle>;
    leftArrowText?: string;
    rightArrowText?: string;
    chosenBulletStyle?: StyleProp<TextStyle>;
    onAnimateNextPage?: (page: number) => void;
    onPageBeingChanged?: (page: number) => void;
    swipe?: boolean;
    isLooped?: boolean;
}
...
export default class Carousel extends Component<CarouselProps, any> {
    ...
    componentDidUpdate({ children }: CarouselProps) {
        if (!isEqual(this.props.children, children)) {
            ...
            if (this.props.children) {
                childrenLength = React.Children.count(this.props.children) || 1;
            }
    ...
    _onScrollBegin = (event: NativeSyntheticEvent<NativeScrollEvent>) => {
        this._clearTimer();
    }
    ...
    _scrollTo = ({ offset, animated, nofix }: { offset: number, animated: boolean, nofix?: boolean }) => {
        if (this.scrollView) {
    ...
    _calculateNextPage = (direction: 'left' | 'right') => {
        const { width } = this.state.size;
    ...
    _renderPageInfo = (pageLength: number) =>
    ...
    _renderBullets = (pageLength: number) => {
        const bullets = [];
